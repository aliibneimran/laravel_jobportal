    ...
    <div class="col-xxl-8 col-xl-7 col-lg-7">
        <div class="section-box">
            <div class="row">
                ...
                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-4 col-sm-6">
                    <div class="card-style-1 hover-up">
                        <div class="card-image"> <img src="backend/assets/imgs/page/dashboard/bank.svg" alt="jobBox"></div>
                        <div class="card-info">
                            <div class="card-title">
                ...
                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-4 col-sm-6">
                    <div class="card-style-1 hover-up">
                        <div class="card-image"> <img src="backend/assets/imgs/page/dashboard/lamp.svg" alt="jobBox"></div>
                        <div class="card-info">
                            <div class="card-title">
                ...
                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-4 col-sm-6">
                    <div class="card-style-1 hover-up">
                        <div class="card-image"> <img src="backend/assets/imgs/page/dashboard/headphone.svg" alt="jobBox"></div>
                        <div class="card-info">
                            <div class="card-title">
                ...
                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-4 col-sm-6">
                    <div class="card-style-1 hover-up">
                        <div class="card-image"> <img src="backend/assets/imgs/page/dashboard/look.svg" alt="jobBox"></div>
                        <div class="card-info">
                            <div class="card-title">
                ...
                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-4 col-sm-6">
                    <div class="card-style-1 hover-up">
                        <div class="card-image"> <img src="backend/assets/imgs/page/dashboard/open-file.svg" alt="jobBox"></div>
                        <div class="card-info">
                            <div class="card-title">
                ...
                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-4 col-sm-6">
                    <div class="card-style-1 hover-up">
                        <div class="card-image"> <img src="backend/assets/imgs/page/dashboard/doc.svg" alt="jobBox"></div>
                        <div class="card-info">
                            <div class="card-title">
                ...
                <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-4 col-sm-6">
                    <div class="card-style-1 hover-up">
                        <div class="card-image"> <img src="backend/assets/imgs/page/dashboard/man.svg" alt="jobBox"></div>
                        <div class="card-info">
                            <div class="card-title">
                ...
                <div class="panel-white">
                    ...
                    <div class="panel-body">
                        <div class="card-style-2 hover-up">
                            <div class="card-head">
                                <div class="card-image"> <img src="backend/assets/imgs/page/dashboard/img1.png" alt="jobBox"></div>
                                <div class="card-title">
                        ...
                        <div class="card-style-2 hover-up">
                            <div class="card-head">
                                <div class="card-image"> <img src="backend/assets/imgs/page/dashboard/img2.png" alt="jobBox"></div>
                                <div class="card-title">
                        ...
                        <div class="card-style-2 hover-up">
                            <div class="card-head">
                                <div class="card-image"> <img src="backend/assets/imgs/page/dashboard/img3.png" alt="jobBox"></div>
                                <div class="card-title">
                        ...
                        <div class="card-style-2 hover-up">
                            <div class="card-head">
                                <div class="card-image"> <img src="backend/assets/imgs/page/dashboard/img4.png" alt="jobBox"></div>
                                <div class="card-title">
                        ...
                        <div class="card-style-2 hover-up">
                            <div class="card-head">
                                <div class="card-image"> <img src="backend/assets/imgs/page/dashboard/img5.png" alt="jobBox"></div>
                                <div class="card-title">
                ...
                <div class="panel-white">
                    ...
                    <div class="panel-body">
                        <div class="card-style-3 hover-up">
                            <div class="card-image online"><img src="backend/assets/imgs/page/dashboard/avata1.png" alt="jobBox"></div>
                            <div class="card-title">
                            ...
                            <div class="card-rating"><img src="backend/assets/imgs/page/dashboard/star.svg" alt="jobBox"> <img src="backend/assets/imgs/page/dashboard/star.svg" alt="jobBox"> <img src="backend/assets/imgs/page/dashboard/star.svg" alt="jobBox"> <img src="backend/assets/imgs/page/dashboard/star.svg" alt="jobBox"> <img src="backend/assets/imgs/page/dashboard/star.svg" alt="jobBox"> <span class="font-xs color-text-mutted">
                                    (65)</span></div>
                        </div>
                        <div class="card-style-3 hover-up">
                            <div class="card-image online"><img src="backend/assets/imgs/page/dashboard/avata2.png" alt="jobBox"></div>
                            <div class="card-title">
                        ...
                        <div class="card-style-3 hover-up">
                            <div class="card-image online"><img src="backend/assets/imgs/page/dashboard/avata3.png" alt="jobBox"></div>
                            <div class="card-title">
                        ...
                        <div class="card-style-3 hover-up">
                            <div class="card-image online"><img src="backend/assets/imgs/page/dashboard/avata4.png" alt="jobBox"></div>
                            <div class="card-title">
                        ...
                        <div class="card-style-3 hover-up">
                            <div class="card-image online"><img src="backend/assets/imgs/page/dashboard/avata5.png" alt="jobBox"></div>
                            <div class="card-title">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 pr-5 pl-5">
                                <div class="card-style-4 hover-up">
                                    <div class="d-flex">
                                        <div class="card-image"><img src="backend/assets/imgs/page/dashboard/avata1.png" alt="jobBox"></div>
                                        <div class="card-title">
                                            <h6>Robert Fox</h6><img src="backend/assets/imgs/page/dashboard/star.svg" alt="jobBox"> <img src="backend/assets/imgs/page/dashboard/star.svg" alt="jobBox"> <img src="backend/assets/imgs/page/dashboard/star.svg" alt="jobBox"> <img src="backend/assets/imgs/page/dashboard/star-none.svg" alt="jobBox"> <img src="backend/assets/imgs/page/dashboard/star-none.svg" alt="jobBox"> <span class="font-xs color-text-mutted">
                                                (65)</span>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 pr-5 pl-5">
                                <div class="card-style-4 hover-up">
                                    <div class="d-flex">
                                        <div class="card-image"><img src="backend/assets/imgs/page/dashboard/avata2.png" alt="jobBox"></div>
                                        <div class="card-title">
                                            <h6>Cody Fisher</h6><img src="backend/assets/imgs/page/dashboard/star.svg" alt="jobBox"> <img src="backend/assets/imgs/page/dashboard/star.svg" alt="jobBox"> <img src="backend/assets/imgs/page/dashboard/star.svg" alt="jobBox"> <img src="backend/assets/imgs/page/dashboard/star-none.svg" alt="jobBox"> <img src="backend/assets/imgs/page/dashboard/star-none.svg" alt="jobBox"> <span class="font-xs color-text-mutted">
                                                (65)</span>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 pr-5 pl-5">
                                <div class="card-style-4 hover-up">
                                    <div class="d-flex">
                                        <div class="card-image"><img src="backend/assets/imgs/page/dashboard/avata3.png" alt="jobBox"></div>
                                        <div class="card-title">
                                            <h6>Jane Cooper</h6><img src="backend/assets/imgs/page/dashboard/star.svg" alt="jobBox"> <img src="backend/assets/imgs/page/dashboard/star.svg" alt="jobBox"> <img src="backend/assets/imgs/page/dashboard/star.svg" alt="jobBox"> <img src="backend/assets/imgs/page/dashboard/star-none.svg" alt="jobBox"> <img src="backend/assets/imgs/page/dashboard/star-none.svg" alt="jobBox"> <span class="font-xs color-text-mutted">
                                                (65)</span>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 pr-5 pl-5">
                                <div class="card-style-4 hover-up">
                                    <div class="d-flex">
                                        <div class="card-image"><img src="backend/assets/imgs/page/dashboard/avata4.png" alt="jobBox"></div>
                                        <div class="card-title">
                                            <h6>Jerome Bell</h6><img src="backend/assets/imgs/page/dashboard/star.svg" alt="jobBox"> <img src="backend/assets/imgs/page/dashboard/star.svg" alt="jobBox"> <img src="backend/assets/imgs/page/dashboard/star.svg" alt="jobBox"> <img src="backend/assets/imgs/page/dashboard/star-none.svg" alt="jobBox"> <img src="backend/assets/imgs/page/dashboard/star-none.svg" alt="jobBox"> <span class="font-xs color-text-mutted">
                                                (65)</span>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 pr-5 pl-5">
                                <div class="card-style-4 hover-up">
                                    <div class="d-flex">
                                        <div class="card-image"><img src="backend/assets/imgs/page/dashboard/avata5.png" alt="jobBox"></div>
                                        <div class="card-title">
                                            <h6>Floyd Miles</h6><img src="backend/assets/imgs/page/dashboard/star.svg" alt="jobBox"> <img src="backend/assets/imgs/page/dashboard/star.svg" alt="jobBox"> <img src="backend/assets/imgs/page/dashboard/star.svg" alt="jobBox"> <img src="backend/assets/imgs/page/dashboard/star-none.svg" alt="jobBox"> <img src="backend/assets/imgs/page/dashboard/star-none.svg" alt="jobBox"> <span class="font-xs color-text-mutted">
                                                (65)</span>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 pr-5 pl-5">
                                <div class="card-style-4 hover-up">
                                    <div class="d-flex">
                                        <div class="card-image"><img src="backend/assets/imgs/page/dashboard/avata1.png" alt="jobBox"></div>
                                        <div class="card-title">
                                            <h6>Devon Lane</h6><img src="backend/assets/imgs/page/dashboard/star.svg" alt="jobBox"> <img src="backend/assets/imgs/page/dashboard/star.svg" alt="jobBox"> <img src="backend/assets/imgs/page/dashboard/star.svg" alt="jobBox"> <img src="backend/assets/imgs/page/dashboard/star-none.svg" alt="jobBox"> <img src="backend/assets/imgs/page/dashboard/star-none.svg" alt="jobBox"> <span class="font-xs color-text-mutted">
                                                (65)</span>
                                        </div>
                                    </div>
                                    <div class="card-location d-flex"><span class="location">Chicago, US</span><span class="jobs-number">25 Open Jobs</span></div>
